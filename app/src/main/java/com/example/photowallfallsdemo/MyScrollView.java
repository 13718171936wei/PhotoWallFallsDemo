...
public class MyScrollView extends ScrollView implements View.OnTouchListener {
    ...
    private static Handler handler = new Handler() {
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            System.out.print("22222222222222222"+scrollY);
            // 如果当前的滚动位置和上次相同，表示已停止滚动
            if (scrollY == lastScrollY) {
                // 当滚动到最底部，并且当前没有正在下载的任务时，开始加载下一页的图片
                if (scrollViewHeight + scrollY >= scrollLayout.getHeight()
                        && taskCollection.isEmpty()) {
                    System.out.print("11111111111111111"+scrollViewHeight);
                    System.out.print("33333333333333333"+scrollLayout.getHeight());
